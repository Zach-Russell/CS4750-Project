...
function renameList($g_name){
    ...
    $query2 = "UPDATE grocery_lists SET g_name=  '$g_name' WHERE g_name = '$old_g_name'";
    ...
    }                                   //it still wouldn't let us rename, so we disabled foreign_key check for a second
    ...
    if($conn->query($queryR)===TRUE){
        ...
        echo "error when setting foreign-key-checks=1;";
    } 
